...
public class BicicletaEletricaDAO {
	...
	public String inserirBicicleta(BicicletaEletrica bicicleta) throws SQLException, BadInfoException {
		...
		String sql = "insert into bicicleta(" + "id_bicicleta," + "marca_bike," + "modelo_bike," + "modalidade_bike,"
				...
				+ " id_bicicleta_eletrica," + "marca_bateria," + "potencia_bateria," + "valor_bateria," + "marca_motor,"
				+ "potencia_motor," + "valor_motor," + "nmr_serie) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
